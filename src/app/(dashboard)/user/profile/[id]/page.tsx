    ...
    return (
        <div className='py-8 px-6'>
                ...
                <section className='flex items-center justify-center flex-col gap-y-3'>
                    {/* First Info */}
                    <div className='w-full rounded-3xl p-7 bg-gray-100 flex items-center justify-center flex-col gap-y-3'>
                        <div className='relative'>
                            <div className='w-[200px] h-[190px] border-[2px] border-primary-1 rounded-full overflow-hidden relative flex items-center justify-center bg-[#F8F7F7] object-cover'>
                            ...
                            <div className='bg-primary-1 h-10 w-10 rounded-full flex justify-center items-center absolute right-0 bottom-5'>
                        ...
                        <div className='flex flex-col justify-center items-center'>
                            ...
                            <p className='text-lg text-gray-500'>Phone Number : 07064553249</p>
                            <p className='text-lg text-gray-500'>Sex : Male | D O B : 26th July</p>
                        </div>
